...
| 문법   | 설명                                                         |
| :----- | :----------------------------------------------------------- |
| ?      | 앞선 문자열이 0 또는 1회 등장하는 문자열을 찾는다.           |
| ?+     | 앞선 문자와 0 회 또는 1회 매칭된다.                          |
| ??     | 앞선 문자와 0 회 또는 1회 매칭된다.                          |
| *      | 앞의 문자열이 0 번 이상 등장하는 문자열을 찾는다.<br />예를 들어, ab\*c는 "ac", "abc", "abbbc", 등과 매칭된다. [xyz]\*는 "", "x", "y", "z", "zx", "zyx", "xyzzy", 등과 일치한다. (ab)*는 "", "ab", "abab", "ababab" 등과 매칭된다. |

...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | PDO_ALTIBASE-1.x.x<br />for PHP 5.3, 7.1 | PDO_ALTIBASE-2.x.x<br />for PHP 8.1 | altiMon | Adapter<br />for JDBC | Adapter<br />for Oracle |
| ------------------------------------------------------------ | :-------------------------------------: | :--------------------------------: | :-----: | :--------------: | :----------------: |
| **AIX on IBM Power Systems**                                 |                                         |                                    |         |                  |                    |
| AIX 6.1                                                      |                  **x**                  |               **x**                |    ●    |        ●         |         ●          |
| AIX 7.1<br/>AIX 7.2                                          |                  **x**                  |               **x**                |    ●<br />Altibase 7.1.0.1.9 이상    |        ●         |       **-**        |
| **HP-UX Itanium (IA-64)**                                    |                                         |                                    |         |                  |                    |
| HP-UX 11.31                                                  |                  **x**                  |               **x**                |    ●    |        ●         |       **x**        |
| **Linux x86-64**                                             |                                         |                                    |         |                  |                    |
...
| **Linux on Power (Little Endian)**                           |                                         |                                    |         |                  |                    |
| POWER8(LE) Red Hat Enterprise Linux 7.2                      |                  **-**                  |               **-**                |    ●<br />Altibase 7.1.0.3.6 이상    | ●<br />Altibase 7.1.0.3.6 이상   |                    |
| **Microsoft Windows (x64)**                                  |                                         |                                    |         |                  |                    |
|                                                              |                  **x**                  |               **x**                |  **x**  |      **x**       |       **x**        |
